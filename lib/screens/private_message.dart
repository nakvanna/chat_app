          ...
          appBar: AppBar(
            ...
            actions: [
              ...
              IconButton(
                ...
                onPressed: () async {
                  sendMessage(
                      ctrl: ctrl, type: 'video_call', message: 'Video Call');
                                      ...
                                      ? Text(DateFormat.jm()
                                          .format(DateTime
                                              .fromMicrosecondsSinceEpoch(
                                                  _messageInfo['timestamp']))
                                          .toString())
                                      : Container()),
                                  Container(
                                    padding: _messageInfo['sentBy'] == _myUID
                                        ? EdgeInsets.fromLTRB(80, 4, 5, 0)
                                        : EdgeInsets.fromLTRB(5, 4, 80, 0),
                                    width: MediaQuery.of(context).size.width,
                                    alignment: _messageInfo['sentBy'] == _myUID
